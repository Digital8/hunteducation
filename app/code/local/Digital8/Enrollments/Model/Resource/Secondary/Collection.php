 ...
 */
/**
 * Secondary collection resource model
 *
 * @category	Digital8
 * @package		Digital8_Enrollments
 * @author Ultimate Module Creator
 */
class Digital8_Enrollments_Model_Resource_Secondary_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract{
	...
	protected function _renderFiltersBefore(){
		if ($this->getFilter('store')) {
			$this->getSelect()->join(
				array('store_table' => $this->getTable('enrollments/secondary_store')),
				'main_table.entity_id = store_table.secondary_id',
				array()
	...
	public function addProductFilter($product){
		...
		if (!isset($this->_joinedFields['product'])){
			$this->getSelect()->join(
				array('related_product' => $this->getTable('enrollments/secondary_product')),
				'related_product.secondary_id = main_table.entity_id',
				array('position')
			);
