 ...
 */
/**
 * Institution admin grid block
 *
 * @category	Digital8
 * @package		Digital8_Enrollments
 * @author Ultimate Module Creator
 */
class Digital8_Enrollments_Block_Adminhtml_Institution_Grid extends Mage_Adminhtml_Block_Widget_Grid{
	/**
	 * constructor
	 * @access public
	 * @return void
	 ...
	 * prepare collection
	 * @access protected
	 * @return Digital8_Enrollments_Block_Adminhtml_Institution_Grid
	 * @author Ultimate Module Creator
	 */
	...
	protected function _prepareColumns(){
		...
		$this->addColumn('course', array(
			'header'=> Mage::helper('enrollments')->__('Course'),
			'index' => 'course',
			'type'	 	=> 'text',
	 ...
	 * get the row url
	 * @access public
	 * @param Digital8_Enrollments_Model_Institution
	 * @return string
	 * @author Ultimate Module Creator
	 */
	 ...
	 * filter store column
	 * @access protected
	 * @param Digital8_Enrollments_Model_Resource_Institution_Collection $collection
