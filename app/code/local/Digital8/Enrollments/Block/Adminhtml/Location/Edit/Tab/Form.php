 ...
 */
class Digital8_Enrollments_Block_Adminhtml_Location_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form{	
	/**
	 * prepare the form
	 * @access protected
	 * @return Enrollments_Location_Block_Adminhtml_Location_Edit_Tab_Form
	 * @author Ultimate Module Creator
	 */
	protected function _prepareForm(){
		...
		$this->setForm($form);
		$fieldset = $form->addFieldset('location_form', array('legend'=>Mage::helper('enrollments')->__('Location')));

		$fieldset->addField('suburb', 'text', array(
			'label' => Mage::helper('enrollments')->__('Suburb'),
			'name'  => 'suburb',
			'required'  => true,
		...
		$fieldset->addField('state', 'text', array(
			'label' => Mage::helper('enrollments')->__('State'),
			'name'  => 'state',
			'required'  => true,
			'class' => 'required-entry',
		...
		$fieldset->addField('address', 'text', array(
			'label' => Mage::helper('enrollments')->__('Address'),
			'name'  => 'address',
			'required'  => true,
			'class' => 'required-entry',
		...
		$fieldset->addField('googlemaps', 'text', array(
			'label' => Mage::helper('enrollments')->__('Google Maps'),
			'name'  => 'googlemaps',
			'required'  => true,
			'class' => 'required-entry',
