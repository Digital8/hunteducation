 ...
 */
class Digital8_Enrollments2_Model_Enrollment extends Mage_Core_Model_Abstract{
	/**
	 * Entity code.
	 * Can be used as part of method name for entity processing
	 */
	const ENTITY= 'enrollments2_enrollment';
	const CACHE_TAG = 'enrollments2_enrollment';
	/**
	 * Prefix of model events names
	 * @var string
	 */
	protected $_eventPrefix = 'enrollments2_enrollment';
	...
	public function getEnrollmentUrl(){
		...
		return Mage::getUrl('enrollments2/enrollment/view', array('id'=>$this->getId()));
	}
	/**
	 * check URL key
	 * @access public
