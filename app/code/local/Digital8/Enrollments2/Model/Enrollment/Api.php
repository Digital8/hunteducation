 ...
 */
class Digital8_Enrollments2_Model_Enrollment_Api extends Mage_Api_Model_Resource_Abstract{
	/**
	 * init enrollment
	 * @access protected
	 * @param $enrollmentId
	...
	protected function _initEnrollment($enrollmentId){
		$enrollment = Mage::getModel('enrollments2/enrollment')->load($enrollmentId);
		if (!$enrollment->getId()) {
