 ...
 */
class Digital8_Enrollments2_Model_Resource_Location_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract{
	 ...
	 * @return Digital8_Enrollments2_Model_Resource_Location_Collection
	 * @author Ultimate Module Creator
	 */
	...
	protected function _renderFiltersBefore(){
		if ($this->getFilter('store')) {
			$this->getSelect()->join(
				array('store_table' => $this->getTable('enrollments2/location_store')),
