 ...
 */
class Digital8_Enrollments2_Block_Adminhtml_Location_Edit_Tab_Meta extends Mage_Adminhtml_Block_Widget_Form{
	/**
	 * prepare the form
	 * @access protected
	 * @return Digital8_Enrollments2_Block_Adminhtml_Location_Edit_Tab_Meta
	 * @author Ultimate Module Creator
	 */
	protected function _prepareForm(){
		...
		$this->setForm($form);
		$fieldset = $form->addFieldset('location_meta_form', array('legend'=>Mage::helper('enrollments2')->__('Meta information')));
