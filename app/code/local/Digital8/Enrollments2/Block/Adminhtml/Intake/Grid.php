 ...
 */
class Digital8_Enrollments2_Block_Adminhtml_Intake_Grid extends Mage_Adminhtml_Block_Widget_Grid{
	/**
	 * constructor
	 * @access public
	 * @return void
	 ...
	 * prepare collection
	 * @access protected
	 * @return Digital8_Enrollments2_Block_Adminhtml_Intake_Grid
	 * @author Ultimate Module Creator
	 */
	...
	protected function _prepareColumns(){
		...
		$locations = Mage::getResourceModel('enrollments2/location_collection')->toOptionHash();
		$this->addColumn('location_id', array(
			'header'	=> Mage::helper('enrollments2')->__('Location'),
			'index'		=> 'location_id',
			'type'		=> 'options',
			'options'	=> $locations
		));
		$this->addColumn('date', array(
			'header'=> Mage::helper('enrollments2')->__('Date'),
			'index' => 'date',
			'type'	 	=> 'date',
	...
	protected function _prepareMassaction(){
		...
		$values = Mage::getResourceModel('enrollments2/location_collection')->toOptionHash();
		$values = array_reverse($values, true); 
		$values[''] = ''; 
		$values = array_reverse($values, true);
		$this->getMassactionBlock()->addItem('location_id', array(
			'label'=> Mage::helper('enrollments2')->__('Change Location'),
	 ...
	 * get the row url
	 * @access public
	 * @param Digital8_Enrollments2_Model_Intake
	 * @return string
	 * @author Ultimate Module Creator
	 */
	 ...
	 * filter store column
	 * @access protected
	 * @param Digital8_Enrollments2_Model_Resource_Intake_Collection $collection
