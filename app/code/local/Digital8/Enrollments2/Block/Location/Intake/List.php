 ...
 */
class Digital8_Enrollments2_Block_Location_Intake_List extends Digital8_Enrollments2_Block_Intake_List{
	/**
	 * initialize
	 * @access public
	 * @return void
	 ...
	 * @access protected
	 * @return Digital8_Enrollments2_Block_Location_Intake_List
	 * @author Ultimate Module Creator
	 */
