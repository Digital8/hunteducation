 ...
 */
class Digital8_Timetable_Block_Adminhtml_Intake_Widget_Chooser extends Mage_Adminhtml_Block_Widget_Grid{
	/**
	...
	public function prepareElementHtml(Varien_Data_Form_Element_Abstract $element){
		...
		$sourceUrl = $this->getUrl('timetable/adminhtml_timetable_intake_widget/chooser', array('uniq_id' => $uniqId));
		$chooser = $this->getLayout()->createBlock('widget/adminhtml_widget_chooser')
				...
				->setUniqId($uniqId);
		if ($element->getValue()) {
			$intake = Mage::getModel('timetable/intake')->load($element->getValue());
			if ($intake->getId()) {
	 ...
	 * @access protected
	 * @return Digital8_Timetable_Block_Adminhtml_Intake_Widget_Chooser
	 * @author Ultimate Module Creator
	 */
	...
	public function getGridUrl(){
		return $this->getUrl('adminhtml/timetable_intake_widget/chooser', array('_current' => true));
	}
	/**
