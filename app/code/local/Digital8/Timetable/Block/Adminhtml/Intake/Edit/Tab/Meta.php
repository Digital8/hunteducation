 ...
 */
class Digital8_Timetable_Block_Adminhtml_Intake_Edit_Tab_Meta extends Mage_Adminhtml_Block_Widget_Form{
	/**
	 * prepare the form
	 * @access protected
	 * @return Digital8_Timetable_Block_Adminhtml_Intake_Edit_Tab_Meta
	 * @author Ultimate Module Creator
	 */
	protected function _prepareForm(){
		...
		$this->setForm($form);
		$fieldset = $form->addFieldset('intake_meta_form', array('legend'=>Mage::helper('timetable')->__('Meta information')));
